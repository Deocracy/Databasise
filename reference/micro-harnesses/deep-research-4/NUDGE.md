...
4. Write findings.md (admitted items with sources; refutations; unresolved ledger; security findings if any; then a final "Harness implications" section of five to ten numbered, cited sentences) and method.md.
