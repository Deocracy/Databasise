...
variant: D5
date: 2026-08-10
status: archived-with-standing — losing variant preserved for the conditions under which it would win again; SELECTION.md ## What the winner inherits from the losers records this variant as contributing edge semantics as a named contract property, runtime-minted instance identity, and budget as a splittable capability token; tracked at SYSTEM-MODEL.md ## §ST
