...
variant: D1
date: 2026-08-10
status: archived-with-standing — the road not taken; revisit if the laundering middle state fails in practice (the `quarantined` artifact scope, SELECTION.md's spike-005 amendment, is the mechanism whose failure would revive it); tracked at SYSTEM-MODEL.md ## §ST
