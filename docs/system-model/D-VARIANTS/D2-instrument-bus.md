...
variant: D2
date: 2026-08-10
status: archived-with-standing — losing variant preserved for the conditions under which it would win again; SELECTION.md ## What the winner inherits from the losers records this variant as contributing the evidence-tier ladder T0-T3, the pooling key, and the cross-tier veto-only rule (Rule 4); tracked at SYSTEM-MODEL.md ## §ST
---
