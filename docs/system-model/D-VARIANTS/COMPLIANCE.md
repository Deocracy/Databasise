...
status: archived-with-standing — the disqualifier compliance verification (CONFIRMED/ASSERTED/VIOLATED/UNCLEAR) SELECTION.md's ruling cites as evidence for each variant's DQ pass, not itself superseded; tracked at SYSTEM-MODEL.md ## §ST
---
