...
def test_default_registry_holds_exactly_twenty_entries():
    ...
    03-06-PLAN.md Task 1's ``join-roundrobin`` — this count grows again once this same plan's
    Task 2 ports the remaining two base-wiring components, per design, not a regression.
    """
